...
/**
 * Offers convenience methods for performing common operations on Parameter Manager including creating
 * and reading parameters.
 */
public class ParameterManagerTemplate implements ParameterManagerOperations {
    ...
    public ParameterManagerTemplate setAllowDefaultSecretValue(boolean allowDefaultParameterValue) {
    ...
    public void createParameter(String parameterId, String versionId, String payload) {
        createNewParameterVersion(parameterId, versionId, ByteString.copyFromUtf8(payload), ParameterFormat.UNFORMATTED, projectIdProvider.getProjectId(), "global");
    }

    @Override
    public void createParameter(String parameterId, String versionId, String payload, ParameterFormat format) {
        createNewParameterVersion(parameterId, versionId, ByteString.copyFromUtf8(payload), format, projectIdProvider.getProjectId(), "global");
    }

    @Override
    public void createParameter(String parameterId, String versionId, String payload, String locationId) {
        createNewParameterVersion(parameterId, versionId, ByteString.copyFromUtf8(payload), ParameterFormat.UNFORMATTED, projectIdProvider.getProjectId(), locationId);
    }

    @Override
    public void createParameter(String parameterId, String versionId, String payload, String locationId, String projectId) {
        createNewParameterVersion(parameterId, versionId, ByteString.copyFromUtf8(payload), ParameterFormat.UNFORMATTED, projectId, locationId);
    }

    @Override
    public void createParameter(String parameterId, String versionId, String payload, ParameterFormat format, String locationId) {
        createNewParameterVersion(parameterId, versionId, ByteString.copyFromUtf8(payload), format, projectIdProvider.getProjectId(), locationId);
    }

    @Override
    public void createParameter(String parameterId, String versionId, String payload, ParameterFormat format, String locationId, String projectId) {
        createNewParameterVersion(parameterId, versionId, ByteString.copyFromUtf8(payload), format, projectId, locationId);
    }

    @Override
    public void createParameter(String parameterId, String versionId, byte[] payload) {
        createNewParameterVersion(parameterId, versionId, ByteString.copyFrom(payload), ParameterFormat.UNFORMATTED, projectIdProvider.getProjectId(), "global");
    }

    @Override
    public void createParameter(String parameterId, String versionId, byte[] payload, ParameterFormat format) {
        createNewParameterVersion(parameterId, versionId, ByteString.copyFrom(payload), format, projectIdProvider.getProjectId(), "global");
    }

    @Override
    public void createParameter(String parameterId, String versionId, byte[] payload, ParameterFormat format, String locationId) {
        createNewParameterVersion(parameterId, versionId, ByteString.copyFrom(payload), format, projectIdProvider.getProjectId(), locationId);
    }

    @Override
    public void createParameter(String parameterId, String versionId, byte[] payload, ParameterFormat format, String locationId, String projectId) {
        createNewParameterVersion(parameterId, versionId, ByteString.copyFrom(payload), format, projectId, locationId);
    }
    ...
    @Override
    public void enableParameterVersion(String parameterId, String versionId, String locationId, String projectId) {
        ParameterVersionName parameterVersionName = ParameterVersionName.of(projectId, locationId, parameterId, versionId);
        ...
        UpdateParameterVersionRequest request = UpdateParameterVersionRequest.newBuilder().setParameterVersion(parameterVersion).setUpdateMask(FieldMaskUtil.fromString("disabled")).build();
    ...
    @Override
    public void disableParameterVersion(String parameterId, String versionId, String locationId, String projectId) {
        ParameterVersionName parameterVersionName = ParameterVersionName.of(projectId, locationId, parameterId, versionId);
    ...
    @Override
    public void deleteParameterVersion(String parameterId, String versionId, String locationId, String projectId) {
        ParameterVersionName parameterVersionName = ParameterVersionName.of(projectId, locationId, parameterId, versionId);
    ...
    public boolean parameterExists(String parameterId, String locationId, String projectId) {
        ParameterName parameterName = ParameterName.of(projectId, locationId, parameterId);
        GetParameterRequest request = GetParameterRequest.newBuilder().setName(parameterName.toString()).build();
        try {
    ...
    public boolean parameterVersionExists(String parameterId, String versionId) {
        return parameterVersionExists(parameterId, versionId, "global", projectIdProvider.getProjectId());
    }

    @Override
    public boolean parameterVersionExists(String parameterId, String versionId, String locationId) {
        return parameterVersionExists(parameterId, versionId, locationId, projectIdProvider.getProjectId());
    }

    @Override
    public boolean parameterVersionExists(String parameterId, String versionId, String locationId, String projectId) {
        ParameterVersionName parameterVersionName = ParameterVersionName.of(projectId, locationId, parameterId, versionId);
    ...
    ByteString getParameterByteString(String parameterIdentifier) {
        ParameterVersionName parameterVersionName = ParameterManagerPropertyUtils.getParameterVersionName(parameterIdentifier, projectIdProvider);
    ...
    ByteString getParameterByteString(ParameterVersionName parameterVersionName) {
        ...
        try {
            parameterData = parameterManagerClient
    ...
    /**
     * Creates a new version of parameter version with the provided {@code payload} under a {@link Parameter}. Will also
     * create a new {@link Parameter} if one does not exist with the provided {@code parameterId}.
     */
    private void createNewParameterVersion(String parameterId, String versionId, ByteString payload, ParameterFormat format, String projectId, String locationId) {
        ...
        CreateParameterVersionRequest payloadRequest = CreateParameterVersionRequest.newBuilder()
                .setParent(parameterName.toString())
                .setParameterVersionId(versionId)
                .setParameterVersion(ParameterVersion.newBuilder().setPayload(parameterVersionPayload).build())
                .build();
        this.parameterManagerClient.createParameterVersion(payloadRequest);
    }

    /**
     * Creates a new {@link Parameter} with the provided {@code format}  for the GCP Project under specified {@code locationId}.
     *
     * <p>Note that the {@link Parameter} object does not contain the parameter version payload. You must create
     * versions of the parameter which stores the payload of the parameter.
     */
    private void createParameterInternal(String parameterId, ParameterFormat format, String projectId, String locationId) {
